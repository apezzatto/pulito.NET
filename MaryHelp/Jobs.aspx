...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="jobs">
        <div>
            ...
            <asp:Label ID="lblMessage" CssClass="" runat="server" Font-Bold="True" ></asp:Label>
        ...
        <table>
			...
			<div class="bottom">
                <asp:Button ID="btnApply" CssClass="btn btn-info" runat="server" Text="Apply" OnClick="btnApply_Click" />
			</div>
    </div>
...
<%--<table id="jobs">
        ...
        <tr>
            <td>
                <asp:Button ID="btnCity" CssClass="btn btn-info btn-city" runat="server" Text="Jobs in my city" Width="105px" OnClick="btnCity_Click" />
                 <asp:Button ID="btnNeighborhood" CssClass="btn btn-info btn-ngh" runat="server" Text="Jobs in my neighborhood" Width="165px" OnClick="btnNeighborhood_Click" /><br />
                <asp:Label ID="lblError" runat="server" Font-Bold="True" Width="1090px"></asp:Label><br />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="lblMessage" CssClass="" runat="server" Font-Bold="True" Width="1090px"></asp:Label>
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Width="1090px"></asp:Label>
            </td>
        </tr>
		<tr>
			<td class="bottom">
